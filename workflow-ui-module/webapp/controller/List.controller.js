sap.ui.define([
    ...
    function (Controller, models) {
        ...
        return Controller.extend("wiprofrm.workflowuimodule.controller.List", {
            onInit: function () {
           ...
           onReadPoData: function(){
            ...
            TigerButtonfunction: function(oEvent) {
               ...
               // var oModel = this.getView().getModel();
                ...
                // oModel.create("/SavingsPOSet", oEntry, {
                //     success: function () {
                ...
                //         console.error("Error occurred while sending leave request:", oError);
                //         // MessageBox.error("Error occurred while sending leave request: " + oError.responseText);
                //     }
                // });
