		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#wiproworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"wiproworkflowuimodule-display": {
								"semanticObject": "wiproworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=wipro.workflowuimodule",
									"url": sap.ui.require.toUrl("wipro/workflowuimodule")
								}
							}
						}
					}
